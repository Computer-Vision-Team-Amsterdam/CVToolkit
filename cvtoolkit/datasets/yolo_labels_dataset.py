...
class YoloLabelsDataset(Dataset):
    ...
    def from_yolo_validation_json(
        ...
        (see e.g. https://roboflow.com/formats/coco-json).
        This method can also be used to load the JSON file that
        is generated by the YoloV8 validation mode.
    ...
    def reset_filter(self):
        """
        Reset all filters and restore dataset to inital state.
        """
        self._filtered_labels = self._labels.copy()
